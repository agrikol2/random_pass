...
count_pass = int(input('Введите количество паролей, которое необходимо сгенерировать: '))
len_pass = int(input('Введите количество символов для одного пароля: '))
digit = input('Включать ли цифры 0123456789? д = да, н = нет: ')
bukv_caps = input('Включать ли прописные буквы ABCDEFGHIJKLMNOPQRSTUVWXYZ? д = да, н = нет: ')
bukv_low = input('Включать ли строчные буквы abcdefghijklmnopqrstuvwxyz? д = да, н = нет: ')
